...
use App\Http\Requests\Belgeler\BasvuruRequest;
use MarcinOrlowski\ResponseBuilder\ResponseBuilder;

class BasvuruBelgeleriController extends Controller
{
    ...
    {
        $belgeler = Belge::where('belge_id', 1)->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(BasvuruRequest $request, $id)
    {
        $belge = Belge::find($id);
        if (!$belge)
            return ResponseBuilder::error();
    ...
    {
        $belgeler = Belge::where('belge_id', 1)->where('status', 'active')->get();
        return ResponseBuilder::success(['belgeler' => $belgeler]);
    }
}

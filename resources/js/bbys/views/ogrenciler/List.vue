                ...
                >
                    <template v-slot:top>
                        <v-toolbar flat color="white">
                            <v-toolbar-title>ÖĞRENCİLER</v-toolbar-title>
                            <v-divider
                                class="mx-4"
                                inset
                                vertical
                                            ...
                                            <v-container>
                                                <v-row>
                                                    <v-col cols="12" sm="6" md="4">
                                                        <v-text-field v-model="editedItem.ogrenci_no" label="Öğ. No"></v-text-field>
                                                    </v-col>
                                                    <v-col cols="12" sm="6" md="4">
                                                        <v-text-field
                                                    ...
                                                    <v-col cols="12" sm="6" md="4">
                                                        <v-select
                                                            label="Kayıt Şekli"
                                                            v-model="editedItem.kayit_sekli"
                                                            :items="kayitSekli"
                                                            item-id="value"
                                                            item-text="value"
                                                            :rules="stringRules"
                                                    ...
                                                    <v-col cols="12" sm="6" md="4">
                                                        <v-menu
                                                            ...
                                                            :return-value.sync="editedItem.kayit_yili"
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                <v-btn text color="primary" @click="$refs.menu.save(editedItem.kayit_yili)">Seç</v-btn>
                                                            </v-date-picker>
                                                        </v-menu>
                                                    </v-col>
                                                    <v-col cols="12" sm="6" md="4">
...
<script>
    export default {
        ...
        data: () => ({
            ...
            headers: [
                { text: 'NO', value: 'ogrenci_no' },
                { text: 'AD', value: 'name' },
                { text: 'E-MAIL', value: 'email' },
                { text: 'KAYIT ŞEKLİ', value: 'kayit_sekli' },
                { text: 'KAYIT YILI', value: 'kayit_yili' },
        ...
        methods: {
            getUsers () {
                api.get('/bbys/ogrenciler')
                    .then(response => {
                        if (response.data.success) {
                            this.Items = response.data.data.ogrenciler;
                        }
                    })
            },
            editItem (item) {
            ...
            deleteItem (item) {
                if (confirm('Bu kullanıcıyı silmek istediğinize emin misiniz?')){
                    ...
                    api.delete('/bbys/ogrenciler/' + item.id).then(response => {
                        if (response.data.success) {
                            setTimeout(() => {
                                this.loader = false;
            ...
            save () {
                ...
                if (this.editedIndex > -1) {
                    ...
                    api.put('/bbys/ogrenciler/' + this.editedItem.id, JSON.stringify(this.editedItem))
                        .then(response => {
                            if(response.data.success) {
                    ...
                    let item = this.editedItem;
                    api.post('/bbys/ogrenciler', JSON.stringify(this.editedItem))
                        .then(response => {
                            if(response.data.success) {
            ...
            resetSpecialValidation(){
                this.editedItem.name='';
                this.editedItem.ogrenci_no='';
                this.editedItem.email='';
                this.editedItem.telefon='';
                this.editedItem.adres='';

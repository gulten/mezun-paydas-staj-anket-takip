                ...
                >
                    <template v-slot:top>
                        <v-toolbar flat color="white">
                            <v-toolbar-title>MEZUNLAR</v-toolbar-title>
                            <v-divider
                                class="mx-4"
                                inset
                                vertical
                                                ...
                                                <v-row>
                                                    ...
                                                    <v-col cols="12" sm="6" md="4">
                                                        <v-menu
                                                            ...
                                                            :return-value.sync="editedItem.mezuniyet_tarihi"
                                                        ...
                                                        >
                                                            <template v-slot:activator="{ on }">
                                                                <v-text-field
                                                                    v-model="editedItem.mezuniyet_tarihi"
                                                            ...
                                                            >
                                                                ...
                                                                <v-btn text color="primary" @click="$refs.menu.save(editedItem.mezuniyet_tarihi)">Seç</v-btn>
                                                            </v-date-picker>
                                                        </v-menu>
                                                    </v-col>
                                                    <v-col cols="12" sm="6" md="4">
                                                        <v-text-field
                                                            v-model="editedItem.mezuniyet_suresi"
...
<script>
    export default {
        ...
        methods: {
            getUsers () {
                api.get('/bbys/mezunlar')
                    .then(response => {
                        if (response.data.success) {
                            this.Items = response.data.data.mezunlar;
                        }
                    });
            },
            editItem (item) {
            ...
            deleteItem (item) {
                if (confirm('Bu kullanıcıyı silmek istediğinize emin misiniz?')){
                    ...
                    api.delete('/bbys/mezunlar/' + item.id).then(response => {
                        if (response.data.success) {
                            setTimeout(() => {
                                this.loader = false;
            ...
            save () {
                ...
                if (this.editedIndex > -1) {
                    ...
                    api.put('/bbys/mezunlar/' + this.editedItem.id, JSON.stringify(this.editedItem))
                        .then(response => {
                            if(response.data.success) {
                    ...
                    let item = this.editedItem;
                    api.post('/bbys/mezunlar', JSON.stringify(this.editedItem))
                        .then(response => {
                            if(response.data.success) {

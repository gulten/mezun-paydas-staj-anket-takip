                ...
                >
                    ...
                    <template v-slot:top>
                        <v-toolbar flat color="white">
                            <v-toolbar-title>KULLANICILAR</v-toolbar-title>
                            <v-divider
                                class="mx-4"
                                inset
                                vertical
        ...
        methods: {
            ...
            deleteItem (item) {
                if (confirm('Bu kullanıcıyı silmek istediğinize emin misiniz?')){
                    ...
                    api.delete('/bbys/kullanicilar/' + item.id).then(response => {
                        if (response.data) {
                            setTimeout(() => {
                                this.loader = false;
            ...
            save () {
                ...
                if (this.editedIndex > -1) {
                    ...
                    api.put('/bbys/kullanicilar/' + this.editedItem.id, JSON.stringify(this.editedItem))
                        .then(response => {
                            if(response.data.success) {
                                ...
                                this.color = 'success';
                                this.snackbar = true;
                                this.snackbarMessage = 'Ekleme İşlemi Başarılı';
                    ...
                    let item = this.editedItem;
                    api.post('/bbys/kullanicilar', JSON.stringify(this.editedItem))
                        .then(response => {
                            if(response.data.success) {

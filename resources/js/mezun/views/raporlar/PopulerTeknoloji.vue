                    ...
                    >
                        <template v-slot:top>
                            <v-toolbar  class="elevation-1 mb-4" color="white">
                                <v-toolbar-title>POPÜLER TEKNOLOJİLER RAPORLAMA</v-toolbar-title>
                                <v-divider
                                    class="mx-4"
                                    inset
                                    vertical
    ...
    export default {
        ...
        data: () => ({
            ...
            headers: [
                ...
                { text: 'MESLEKİ FAALİYET', value: 'mesleki_faaliyet', filterable: false },
                { text: 'KULLANILAN TEKNOLOJİLER', value: 'kullanilan_teknolojiler', filterable: false },
                { text: 'AÇIKLAMALAR', value: 'aciklamalar', filterable: false },
            ],
            Items: [],
        ...
        methods: {
            getUsers () {
                ...
                api.post('/mezun/populer-teknoloji/rapor', formData)
                    .then(response => {
                        if (response.data.success) {
                            ...
                            response.data.data.liste.forEach(function(item) {
                                    this.Items.push({
                                        ...
                                        'aciklamalar': item.aciklamalar,
                                        'kullanilan_teknolojiler': item.kullanilan_teknolojiler,
                                        'mesleki_faaliyet': item.mesleki_faaliyet,

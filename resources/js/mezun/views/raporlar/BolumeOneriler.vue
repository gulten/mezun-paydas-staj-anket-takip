<template>
    <div>
        ...
        <v-dialog
            ...
            >
            <v-card>
                <v-card-title class="headline text-center">ALANA GÖRE ANALİZ VERİSİ</v-card-title>
        ...
        <div class="container">
            <v-card>
                ...
                <v-row>
                        ...
                        <v-col cols="6">
                            <v-autocomplete
                                v-model="field_not_null"
                                :items="graphFieldsList"
                                label="Şu Alan Boş Gelmesin"
                                item-value="value"
                                item-text="text"
                                dense
                                chips
                                ...
                                outlined
                                persistent-hint
                                hint="Seçtiğiniz Alanda Boş Kayıtlar Görüntülenmeyecektir"
                            >
                            </v-autocomplete>
                        </v-col>
                        <v-col cols="4">
                    ...
                    >
                        <template v-slot:top>
                            <v-toolbar  class="elevation-1 mb-4" color="white">
                                <v-toolbar-title>BÖLÜME ÖNERİLER RAPORLAMA</v-toolbar-title>
                                <v-divider
                                    class="mx-4"
                                    inset
                                    vertical
    ...
    export default {
        ...
        data: () => ({
            ...
            headers: [
                ...
                { text: 'İÇERİK', value: 'icerik', filterable: false },
                { text: 'İÇERİĞE YÖNELİK ÖNERİLER', value: 'icerige_yonelik', filterable: false },
            ],
            Items: [],
            ...
            heads :  [
                ...
                { text: 'AMAÇ', value: 'amac', filterable: false },
                { text: 'AMACA YÖNELİK ÖNERİLER', value: 'amaca_yonelik', filterable: false },
                { text: 'İÇERİK', value: 'icerik', filterable: false },
                { text: 'İÇERİĞE YÖNELİK ÖNERİLER', value: 'icerige_yonelik', filterable: false },
                { text: 'HAFTALIK DERS SAATİ', value: 'haftalik_ders_saati', filterable: false },
                { text: 'DERS YARIYILINA VE SAATİNE YÖNELİK ÖNERİLER', value: 'ders_yariyilina_saatine_yonelik', filterable: false },
                { text: 'DİĞER GÖRÜŞLER', value: 'diger', filterable: false },
        ...
        methods: {
            ...
            getUsers () {
                ...
                formData.append('field_not_null', this.field_not_null || '');
                api.post('/mezun/bolume-oneriler/rapor', formData)
                    .then(response => {
                        if (response.data.success) {
                            this.Items = [];
                            response.data.data.liste.forEach(function(item) {
                                    this.Items.push({
                                        ...
                                        'amac': item.bolumders.amac,
                                        'amaca_yonelik': item.amaca_yonelik,
                                        'icerik': item.bolumders.icerik,
                                        'icerige_yonelik': item.icerige_yonelik,
                                        'donem': item.bolumders.donem,
                                        'haftalik_ders_saati': item.bolumders.haftalik_ders_saati,
                                        'ders_yariyilina_saatine_yonelik': item.ders_yariyilina_saatine_yonelik,
                                        'diger': item.diger,
            ...
            createPDF(){
                ...
                doc.save('bolumeoneriler.pdf');
            },
            viewChart() {
                        let labels = ["ÖNERİDE BULUNAN", "ÖNERİDE BULUNMAYAN"];
                        let dataset = [];
                        ...
                        this.datacollection = {
                            ...
                            datasets: [
                                {
                                    label: "ALANA GÖRE ANALİZ VERİSİ",
                                    backgroundColor: [
                                        'rgba(255, 99, 132, 0.9)',
                                        'rgba(54, 162, 235, 0.9)',
                                        'rgba(255, 206, 86, 0.9)',
                                    ...
                                    data: [this.chart[this.graphField]['not_null'], this.chart[this.graphField]['null']]
                                }
                            ]
                        }
            },

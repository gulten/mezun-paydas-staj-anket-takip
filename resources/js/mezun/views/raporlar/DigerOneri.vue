                    ...
                    >
                        <template v-slot:top>
                            <v-toolbar  class="elevation-1 mb-4" color="white">
                                <v-toolbar-title>BÖLÜME DİĞER ÖNERİ RAPORLAMA</v-toolbar-title>
                                <v-divider
                                    class="mx-4"
                                    inset
                                    vertical
    ...
    export default {
        ...
        data: () => ({
            ...
            headers: [
                ...
                { text: 'ÖNERİ', value: 'oneri', filterable: false },
            ],
            Items: [],
        ...
        methods: {
            getUsers () {
                ...
                api.post('/mezun/bolum-diger-oneri/rapor', formData)
                    .then(response => {

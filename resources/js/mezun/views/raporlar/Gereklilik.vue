<template>
    <div>
        ...
        <v-dialog
            ...
            >
            <v-card>
                <v-card-title class="headline text-center">GEREKLİLİK SKORU ANALİZ VERİSİ</v-card-title>
                    ...
                    >
                        <template v-slot:top>
                            <v-toolbar  class="elevation-1 mb-4" color="white">
                                <v-toolbar-title>DERS GEREKLİLİK RAPORLAMA</v-toolbar-title>
                                <v-divider
                                    class="mx-4"
                                    inset
                                    vertical
    ...
    export default {
        ...
        data: () => ({
            ...
            headers: [
                ...
                { text: 'GEREKLİLİK SKORU (1-5 Arası)', value: 'gereklilik', filterable: false },
        ...
        methods: {
            ...
            getUsers () {
                ...
                api.post('/mezun/ders-gereklilik/rapor', formData)
                    .then(response => {
                        if (response.data.success) {
                            this.Items = [];
            ...
            viewChart() {
                ...
                this.datacollection = {
                    ...
                    datasets: [
                        {
                            label: "GEREKLİLİK SKORU ANALİZ VERİSİ",
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.9)',
                                'rgba(54, 162, 235, 0.9)',
                                'rgba(255, 206, 86, 0.9)',

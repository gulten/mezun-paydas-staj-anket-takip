                    ...
                    >
                        <template v-slot:top>
                            <v-toolbar  class="elevation-1 mb-4" color="white">
                                <v-toolbar-title>PAYDAŞ BİLGİLERİ RAPORLAMA</v-toolbar-title>
                                <v-divider
                                    class="mx-4"
                                    inset
                                    vertical
    ...
    export default {
        ...
        methods: {
            getUsers () {
                ...
                api.post('/mezun/paydas/rapor', JSON.stringify({
            ...
            createPDF(){
                ...
                doc.autoTable({
                    ...
                    "columnStyles": { "[0]": { "halign": "left", "cellWidth": "auto"}, "[1]": { "halign": "left", "cellWidth": "auto" }, "[2]": { "halign": "left"} },
                    "theme": "grid",
                    "pageBreak": "auto",
                    "tableWidth": "auto",
                    "showHead": "everyPage",

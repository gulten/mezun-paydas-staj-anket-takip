                ...
                >
                    <template v-slot:top>
                        <v-toolbar flat color="white">
                            <v-toolbar-title>PAYDAŞ İŞ DENEYİMLERİ</v-toolbar-title>
                            <v-divider
                                class="mx-4"
                                inset
                                vertical
...
<script>
    export default {
        ...
        methods: {
            getUsers () {
                api.get('mezun/paydas-isdeneyimi')
                    .then(response => {
            ...
            deleteItem (item) {
                if (confirm('Bu kaydı silmek istediğinize emin misiniz?')){
                    ...
                    api.delete('/mezun/paydas-isdeneyimi/' + item.id).then(response => {
                        if (response.data.success) {
                            setTimeout(() => {
                                this.loader = false;
            ...
            save () {
                ...
                if (this.editedIndex > -1) {
                    ...
                    api.put('mezun/paydas-isdeneyimi/' + this.editedItem.id, JSON.stringify(this.editedItem))
                        .then(response => {
                            if(response.data.success) {
                    ...
                    let item = this.editedItem;
                    api.post('mezun/paydas-isdeneyimi', JSON.stringify(this.editedItem))
                        .then(response => {
                            if(response.data.success) {

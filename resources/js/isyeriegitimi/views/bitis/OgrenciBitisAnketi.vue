            ...
            <template v-else-if="complate===2">
                ...
                >
                    <v-card-text>
                            ...
                            Komisyona staj bitiminde teslim etmeniz gereken belgeleri teslim ediniz.
                    </v-card-text>
                    <v-card-actions>
                        <v-btn
                            outlined
                            rounded
                            text
                            href="/isyeriegitimi/bitis-anketi/ogrenci/cevaplar"
                        >
                            Anket Cevapları
                        </v-btn>
                    </v-card-actions>
...
<script>
    export default {
        ...
        methods: {
            getData () {
                api.get('/isyeriegitimi/bitis-anketi/ogrenci')
                    .then(response => {
            ...
            save () {
                ...
                api.post('/isyeriegitimi/bitis-anketi/ogrenci', this.anket)
                    .then(response => {
                        if(response.data.success) {
                            this.snackbar = true;

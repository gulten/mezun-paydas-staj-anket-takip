...
return [
    ...
    */
    'map'               => [
        ApiCode::AuthenticationFailed        => 'api.AuthenticationFailed',
        ApiCode::UnprocessableEntity         => 'api.UnprocessableEntity',
        ApiCode::InvalidUser                 => 'api.InvalidUser',
        ApiCode::TokenNotValid               => 'api.TokenNotValid',
        ApiCode::ResetLinkFailed             => 'api.ResetLinkFailed',
        ApiCode::LoggedInBefore              => 'api.LoggedInBefore',
        ApiCode::CantLogin                   => 'api.CantLogin',
        ApiCode::CanLogin                    => 'api.CanLogin',
        ApiCode::EmailVerifiedBefore         => 'api.VerifiedBefore',
        ApiCode::EmailVerifiedSuccessfully   => 'api.EmailVerifiedSuccessfully',
        ApiCode::VerificationLinkSent        => 'api.VerificationLinkSent',
        ApiCode::DeletionLogicError          => 'api.DeletionLogicError',
        ApiCode::BranchHasActiveAppointments => 'api.BranchHasActiveAppointments',
    ],
    /*
    |-----------------------------------------------------------------------------------------------------------
    ...
    */
    'converter'         => [
        ...
        \Illuminate\Http\Resources\Json\JsonResource::class => [
            'handler' => \App\Http\ResponseConverters\JsonResourceToArrayConverter::class,
            // 'key'     => 'item',
            'pri'     => 0,
        ],
        /*
